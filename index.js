    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    res = _a.sent();
                    return [2 /*return*/, res.userInput];
            }
        });
    });
}
function startTime(val) {
    var targetTime = new Date(Date.now() + val * 1000);
    var interval = setInterval(function () {
        var currentTime = new Date();
        var timeDiff = (0, date_fns_1.differenceInSeconds)(targetTime, currentTime);
        if (timeDiff <= 0) {
